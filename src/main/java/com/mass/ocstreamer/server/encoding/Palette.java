...
public class Palette {
    ...
    public static int getClosestIndex(Color color)  {
        int closestIndex = 0;
        double delta;
        double closestDelta = 999999999.0d;
        Color paletteColor;
        ...
        for (int i = 0; i < colors.length; i++) {
            ...
            delta = Math.pow(paletteColor.red - color.red, 2) +
                    Math.pow(paletteColor.green - color.green, 2) +
                    Math.pow(paletteColor.blue - color.blue, 2);
    ...
    {
        return new Color(0xFF000000 | colors[paletteIndex]);
    }
